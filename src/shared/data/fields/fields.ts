import pomeranianDogImg from './images/pomeranianDogImg.jpg'
import dogFoodImg from './images/dogFoodImg.jpg'
import dogMessImg from './images/dogMessImg.jpg'

export const FIELDS = [
    {
        id: 1,
        image: pomeranianDogImg,
